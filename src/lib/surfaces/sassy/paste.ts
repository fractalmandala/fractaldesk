// The paste "Convert" action, driven from the header toolbar. Reads the input
// pane, writes the output/error panes — all through shared state so the button
// can live in the header away from the panes.

import { say } from '../../store.svelte.js'
import { sassToCss, cssToSass } from './convert.js'

...
const RULES: Array<[Category, RegExp]> = [
  ...
  ['Typography', /^(text-|font-|tracking-|leading-|uppercase|lowercase|capitalize|normal-case|italic|not-italic|underline|overline|line-through|no-underline|decoration-|antialiased|truncate|whitespace-|break-|align-|sr-only|not-sr-only)/],
  ['Surface', /^(bg-|from-|via-|to-|fill-|stroke-|accent-|caret-|placeholder-)/],
  ['Effect', /^(shadow|opacity-|mix-blend-|bg-blend-|blur|brightness-|contrast-|grayscale|hue-rotate|invert|saturate-|sepia|backdrop-|transition|duration-|ease-|delay-|animate-|fade-|zoom-|spin-|slide-|transform|scale-|rotate-|translate-|skew-|cursor-|pointer-events-|select-|filter|will-change|clip-|mask-|appearance-|forced-color-|resize-)/]
]

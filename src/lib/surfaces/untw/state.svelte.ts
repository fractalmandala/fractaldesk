// Shared Untw state. The Convert/Copy controls live in the surface toolbar
// (surfaces/untw/Toolbar.svelte); the panes in Surface.svelte bind to this so a
// toolbar button can drive the paste conversion. Mirrors
// surfaces/sassy/state.svelte.ts.
